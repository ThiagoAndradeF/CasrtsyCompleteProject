...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230831004135_AddressChangeUF")]
    partial class AddressChangeUF
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            Date = new DateTime(2023, 8, 31, 0, 41, 35, 630, DateTimeKind.Utc).AddTicks(1020),
                            Price = 499.99000000000001,
                            StatusId = 1,
                            StoreId = 1
                        });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 8, 31, 0, 41, 35, 630, DateTimeKind.Utc).AddTicks(1050)
                        });
                });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 8, 31, 0, 41, 35, 630, DateTimeKind.Utc).AddTicks(1030)
                        },
                        new
                        {
                            ServicesId = 2,
                        ...
                        new
                        {
                            ServicesId = 3,
                            StoreId = 3,
                            CreatedAt = new DateTime(2023, 8, 31, 0, 41, 35, 630, DateTimeKind.Utc).AddTicks(1040)
                        });
                });
