...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230829234916_testMockValues")]
    partial class testMockValues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            Date = new DateTime(2023, 8, 29, 23, 49, 15, 944, DateTimeKind.Utc).AddTicks(8760),
                            Price = 499.99000000000001,
                            StatusId = 1,
                            StoreId = 1
                        });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 8, 29, 23, 49, 15, 944, DateTimeKind.Utc).AddTicks(8780)
                        });
                });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 8, 29, 23, 49, 15, 944, DateTimeKind.Utc).AddTicks(8770)
                        },
                        new
                        {
                            ServicesId = 2,
