...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230905224803_CustomerNowHasFKStoreId")]
    partial class CustomerNowHasFKStoreId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            Date = new DateTime(2023, 9, 5, 22, 48, 3, 335, DateTimeKind.Utc).AddTicks(5110),
                            Price = 499.99000000000001,
                            StatusId = 1,
                            StoreId = 1
                        });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 9, 5, 22, 48, 3, 335, DateTimeKind.Utc).AddTicks(5130)
                        });
                });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 9, 5, 22, 48, 3, 335, DateTimeKind.Utc).AddTicks(5120)
                        },
                        new
                        {
                            ServicesId = 2,
