...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230912092412_orderValues")]
    partial class orderValues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            DateCreated = new DateTime(2023, 9, 12, 9, 24, 12, 465, DateTimeKind.Utc).AddTicks(3291),
                        ...
                        new
                        {
                            Id = 2,
                            ConsumerId = 2,
                            DateCreated = new DateTime(2023, 9, 12, 9, 24, 12, 465, DateTimeKind.Utc).AddTicks(3294),
                            DateDelivered = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Price = 19.989999999999998,
                            StatusId = 2,
                            StoreId = 2
                        ...
                        new
                        {
                            Id = 3,
                            ConsumerId = 3,
                            DateCreated = new DateTime(2023, 9, 12, 9, 24, 12, 465, DateTimeKind.Utc).AddTicks(3295),
                            DateDelivered = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Price = 12.99,
                            StatusId = 3,
                            StoreId = 3
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 9, 12, 9, 24, 12, 465, DateTimeKind.Utc).AddTicks(3316)
                        },
                        new
                        {
                            ItemId = 2,
                            OrderId = 2,
                            CreatedAt = new DateTime(2023, 9, 12, 9, 24, 12, 465, DateTimeKind.Utc).AddTicks(3317)
                        },
                        new
                        {
                            ItemId = 3,
                            OrderId = 3,
                            CreatedAt = new DateTime(2023, 9, 12, 9, 24, 12, 465, DateTimeKind.Utc).AddTicks(3318)
                        });
                });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 9, 12, 9, 24, 12, 465, DateTimeKind.Utc).AddTicks(3306)
                        },
                        new
                        {
                            ServicesId = 2,
                            StoreId = 2,
                            CreatedAt = new DateTime(2023, 9, 12, 9, 24, 12, 465, DateTimeKind.Utc).AddTicks(3307)
                        },
                        new
                        {
                            ServicesId = 3,
                            StoreId = 3,
                            CreatedAt = new DateTime(2023, 9, 12, 9, 24, 12, 465, DateTimeKind.Utc).AddTicks(3308)
                        });
                });
