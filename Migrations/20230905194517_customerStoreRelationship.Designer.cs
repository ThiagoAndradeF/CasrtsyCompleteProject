...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230905194517_customerStoreRelationship")]
    partial class customerStoreRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            Date = new DateTime(2023, 9, 5, 19, 45, 17, 47, DateTimeKind.Utc).AddTicks(2230),
                            Price = 499.99000000000001,
                            StatusId = 1,
                            StoreId = 1
                        });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 9, 5, 19, 45, 17, 47, DateTimeKind.Utc).AddTicks(2250)
                        });
                });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 9, 5, 19, 45, 17, 47, DateTimeKind.Utc).AddTicks(2240)
                        },
                        new
                        {
                            ServicesId = 2,
