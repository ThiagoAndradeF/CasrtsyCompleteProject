...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230906222142_StoreHasCustomerId")]
    partial class StoreHasCustomerId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            Date = new DateTime(2023, 9, 6, 22, 21, 42, 368, DateTimeKind.Utc).AddTicks(2520),
                            Price = 499.99000000000001,
                            StatusId = 1,
                            StoreId = 1
                        });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 9, 6, 22, 21, 42, 368, DateTimeKind.Utc).AddTicks(2540)
                        });
                });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 9, 6, 22, 21, 42, 368, DateTimeKind.Utc).AddTicks(2530)
                        },
                        new
                        {
                            ServicesId = 2,
