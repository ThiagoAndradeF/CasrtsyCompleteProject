...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230905223014_CustomerOrderRealationshipUpdated_ONEtoONE")]
    partial class CustomerOrderRealationshipUpdated_ONEtoONE
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            Date = new DateTime(2023, 9, 5, 22, 30, 14, 245, DateTimeKind.Utc).AddTicks(8560),
                            Price = 499.99000000000001,
                            StatusId = 1,
                            StoreId = 1
                        });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 9, 5, 22, 30, 14, 245, DateTimeKind.Utc).AddTicks(8590)
                        });
                });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 9, 5, 22, 30, 14, 245, DateTimeKind.Utc).AddTicks(8580)
                        },
                        new
                        {
                            ServicesId = 2,
