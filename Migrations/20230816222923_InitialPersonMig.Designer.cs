...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Consumer", b =>
                {
                    b.HasBaseType("Cartsy.Api.Entities.Person");
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Person", b =>
                {
                    b.HasOne("Cartsy.Api.Entities.Address", "Address")
                        .WithOne("Person")
                        .HasForeignKey("Cartsy.Api.Entities.Person", "IdAddress")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Store", b =>
                {
                    b.HasOne("Cartsy.Api.Entities.Address", "Address")
                        .WithOne("Store")
                        .HasForeignKey("Cartsy.Api.Entities.Store", "IdAddress")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
