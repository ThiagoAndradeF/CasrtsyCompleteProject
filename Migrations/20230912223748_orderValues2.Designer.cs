...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230912223748_orderValues2")]
    partial class orderValues2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            DateCreated = new DateTime(2023, 9, 12, 22, 37, 48, 478, DateTimeKind.Utc).AddTicks(9590),
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 9, 12, 22, 37, 48, 478, DateTimeKind.Utc).AddTicks(9610)
                        },
                        new
                        {
                            ItemId = 2,
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 9, 12, 22, 37, 48, 478, DateTimeKind.Utc).AddTicks(9600)
                        },
                        new
                        {
                            ServicesId = 2,
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.LegalCustomer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            AddressId = 1,
                            CellPhone = "234-567-8901",
                            Email = "casas@bahia.com",
                            HomePhone = "876-543-2109",
                            Name = "Dono da Casas Bahia",
                            Status = true,
                            TypeDiscriminator = 1,
                            CNPJ = "12345678901234",
                            Type = "legal"
