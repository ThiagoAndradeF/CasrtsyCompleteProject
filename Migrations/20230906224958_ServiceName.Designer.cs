...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230906224958_ServiceName")]
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            Date = new DateTime(2023, 9, 6, 22, 49, 58, 431, DateTimeKind.Utc).AddTicks(4440),
                            Price = 499.99000000000001,
                            StatusId = 1,
                            StoreId = 1
                        });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 9, 6, 22, 49, 58, 431, DateTimeKind.Utc).AddTicks(4460)
                        });
                });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 9, 6, 22, 49, 58, 431, DateTimeKind.Utc).AddTicks(4450)
                        },
                        new
                        {
                            ServicesId = 2,
