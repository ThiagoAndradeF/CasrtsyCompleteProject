...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230912091825_orderHasPropDateDelivered")]
    partial class orderHasPropDateDelivered
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            DateCreated = new DateTime(2023, 9, 12, 9, 18, 25, 536, DateTimeKind.Utc).AddTicks(847),
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 9, 12, 9, 18, 25, 536, DateTimeKind.Utc).AddTicks(869)
                        });
                });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 9, 12, 9, 18, 25, 536, DateTimeKind.Utc).AddTicks(858)
                        },
                        new
                        {
                            ServicesId = 2,
                            StoreId = 2,
                            CreatedAt = new DateTime(2023, 9, 12, 9, 18, 25, 536, DateTimeKind.Utc).AddTicks(860)
                        },
                        new
                        {
                            ServicesId = 3,
                            StoreId = 3,
                            CreatedAt = new DateTime(2023, 9, 12, 9, 18, 25, 536, DateTimeKind.Utc).AddTicks(861)
                        });
                });
