...
namespace Cartsy.Api.Migrations
{
    ...
    [Migration("20230905230006_CustomerHasTypeInChildrenTable")]
    partial class CustomerHasTypeInChildrenTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ConsumerId = 1,
                            Date = new DateTime(2023, 9, 5, 23, 0, 6, 732, DateTimeKind.Utc).AddTicks(1220),
                            Price = 499.99000000000001,
                            StatusId = 1,
                            StoreId = 1
                        });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.OrderItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ItemId = 1,
                            OrderId = 1,
                            CreatedAt = new DateTime(2023, 9, 5, 23, 0, 6, 732, DateTimeKind.Utc).AddTicks(1240)
                        });
                });
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.StoreService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ServicesId = 1,
                            StoreId = 1,
                            CreatedAt = new DateTime(2023, 9, 5, 23, 0, 6, 732, DateTimeKind.Utc).AddTicks(1230)
                        },
                        new
                        {
                            ServicesId = 2,
            ...
            modelBuilder.Entity("Cartsy.Api.Entities.Customer", b =>
                {
                    ...
                    b.HasOne("Cartsy.Api.Entities.Store", "Store")
                        .WithOne("Customer")
                        .HasForeignKey("Cartsy.Api.Entities.Customer", "StoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
